...
// Commented out CustomOpenIDStrategy class to avoid ESM issues
/*
...
async function setupOpenId() {
  // OpenID setup disabled to avoid ESM issues
  logger.info('[openidStrategy] OpenID authentication is disabled');
  return null;
  
  /*
  try {
    // Original OpenID setup code commented out
